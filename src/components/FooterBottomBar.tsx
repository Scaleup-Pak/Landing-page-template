export type FooterBottomSocialLink = {
...
type FooterBottomBarProps = {
  copyright: string;
  socialLinks: FooterBottomSocialLink[];
};

const iconClass = "h-[30px] w-[30px] sm:h-[34px] sm:w-[34px]";

function SocialIcon({ id }: { id: FooterBottomSocialLink["id"] }) {
  switch (id) {
    case "youtube":
      return (
...
export function FooterBottomBar({ copyright, socialLinks }: FooterBottomBarProps) {
  return (
    <div className="w-full px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 2xl:px-[106px]">
      <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center justify-between gap-4 py-5 sm:flex-row sm:py-[30px]">
